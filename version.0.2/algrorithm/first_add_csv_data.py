...
def checkNewCourse(path, course_id):
    ...
    if course_id in course_ids:
        ...
        with open('version.0.2/datasets/data/student_in_course_detail/'+ course_id +'.csv', mode='w', newline='') as csv_file:
            writer = csv.writer(csv_file)
            writer.writerow(['Student ID', 'Name'])
        with open('version.0.2/datasets/data/attendance/'+ course_id +'_attendence.csv', mode='w', newline='') as csv_file:
            writer = csv.writer(csv_file)
