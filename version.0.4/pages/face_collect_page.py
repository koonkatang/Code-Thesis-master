...
def chooseStudentIDpopUp(course_id):
    ...
    path = 'C:/Users/koonk/Desktop/Code-Thesis-master/version.0.4/datasets/data/student_in_course_detail/'
    course_label = ctk.CTkLabel(master=window, 
                              text="Course : "+str(course_id), 
                              font=("Leelawadee", 30) ,
                              padx=100, pady=10)
    course_label.pack()
    order_label = ctk.CTkLabel(window, 
                              text="Choose Student : ", 
                              font=("Leelawadee", 15) ,
                              padx=100, pady=10)
    order_label.pack()
    ...
    id_entry = ctk.CTkEntry(add_frame)
    id_entry.grid(row=1, column=0)
    name_label = ctk.CTkLabel(add_frame, text="Full Name")
    name_label.grid(row=0, column=1)
    name_entry = ctk.CTkEntry(add_frame)
    ...
    # Submit Button
    submit_button = ctk.CTkButton(master=window, fg_color="green",
                            text="Submit",
...
def runFaceDataCollect(course_id, student_id):
    ...
    result = messagebox.askyesno("Warning", "Do you want to add another student's face?")
